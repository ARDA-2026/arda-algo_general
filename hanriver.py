...
# ─────────────────────────────────────────
# [3-1] 실물 축소 지도 영역 (3m × 2m, 축척 1:850)
# ─────────────────────────────────────────
...
MAP_SCALE   = 850     # 1:850 — 덮는 실제 2550 x 1700 m
...
#     서강대교  경도 126.92186~126.93125  위도 37.53225~37.54667
...
#
# 결과 bbox: 126.91471,37.52704 ~ 126.94369,37.54236 (밤섬 전체 + 입수 지점 포함).
# 인쇄물은 이 bbox 로 뽑아야 바닥과 화면이 맞는다.
MAP_EAST_M  = 641.4    # 입수 지점에서 동쪽 여유 (나머지는 서쪽 표류 구간)
MAP_SOUTH_M = 727.9    # 입수 지점에서 남쪽 여유 (나머지는 북쪽 구간)
